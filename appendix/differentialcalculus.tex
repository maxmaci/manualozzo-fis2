...
\begin{define}[Campo solenoidale e vettore potenziale]
	Dato un campo vettoriale $\vba{G}$, se esiste un campo vettoriale $\vba{A}$ tale che $\vba{G}=\curl{\vba{A}}$, allora $\vba{G}$ viene detto \textbf{solenoidale}\index{campo!solenoidale} e il campo vettoriale $\vba{A}$ è detto \textbf{vettore potenziale}\index{vettore potenziale}.
\end{define}
...
\begin{enumerate}[label=\roman*)]
	\item  $\div{\left(\grad\phi\right)}=\laplacian{\phi}$, dove $\laplacian{\phi}$ è il \textbf{laplaciano}\index{laplaciano}:
	\begin{equation}
