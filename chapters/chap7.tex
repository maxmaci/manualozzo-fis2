...
\begin{digressionwt}[\textit{Una montagna da Watussi.} Una breve storia sulla bussola e i poli magnetici terrestri nell'Età delle Grandi Scoperte]
	...
	\begin{center}
			...
			\fbox{\includegraphics[width=0.75\textwidth]{images/mercator.jpg}}
	\end{center}
\begin{center}
...
\end{center}
% https://www.davidrumsey.com/luna/servlet/detail/RUMSEY~8~1~332481~90101091:Septentrionalium-Terrarum-descripti?sort=Pub_List_No_InitialSort%2CPub_Date%2CPub_List_No%2CSeries_No#
...
\begin{example}[Fascia di Van Allen]
	...
	Nella fascia di Van Allen \textit{esterna}, il campo magnetico è più debole e contiene principalmente elettroni ad alta energia (tra $0,1$ e $\SI{100}{\mega\electronvolt}$).% earth from wikipedia
\end{example}
