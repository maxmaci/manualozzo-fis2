...
\begin{introduction}
	...
	\begin{flushright}
		\textsc{Dave Barry}, poco prima di essere bocciato all'esame di Fisica II.
	\end{flushright}
\end{introduction} %TODO: intro
\lettrine[findent=1pt, nindent=0pt]{N}{ei} capitoli precedenti abbiamo esplorato i fenomeni elettrostatici. 
\section{Corrente elettrica}
% Ci sono diversi tipi di conduttori. %TODO: intro buona
...
\begin{examplewt}[Elettroni liberi in diversi materiali]
	...
	\begin{itemize}
		\item \textbf{Rame (Cu)}%TODO: do we need mchem package?
		\begin{equation*}
		...
		\end{equation*} 
		\item \textbf{Argento (Ag)}%TODO: do we need mchem package?
		\begin{equation*}
...
\begin{equation*}
	\int_{\Sigma}\vba{j}\vdot\vbh{u}_nd\Sigma=-\pdv{q_int}{t}=-\int_V\pdv{\rho}{t} dV %TODO: completare
\end{equation*}
...
Nel \refChapter{conduttori} abbiamo introdotto brevemente i \textit{circuiti elettrici}, limitandoci a studiare come si comportano dei condensatori collegati in serie e in parallelo. Ora riprendiamo e approfondiamo ciò che abbiamo detto, alla luce delle nostre nuove conoscenze sulla corrente elettrica.
...
\begin{itemize}
	...
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
\end{itemize}%TODO: add rules diagram
...
\subsection{Circuiti RC e processo di carica di un condensatore}\label{CircuitiRC}%TODO: processo di scarica
