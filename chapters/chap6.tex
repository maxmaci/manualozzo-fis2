...
\begin{introduction}
	...
	\begin{flushright}
		\textscsl{Brick Tamland}, \emph{Anchorman - La leggenda di Ron Burgundy}. 
	\end{flushright}
\end{introduction}
