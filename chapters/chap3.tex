...
\end{define}
\begin{examples}~{}%TODO: rifare gli schemi in modo che siano ortogonali
	\begin{itemize}
...
\end{center}
\paragraph{Superficie cilindrica uniformemente carica}
...
A questo punto siamo arrivati ad avere tutti gli strumenti e i risultati necessari per enunciare le \textbf{equazioni di Maxwell relative all'elettrostatica}.c Tuttavia, prima di far ciò è importante riprendere in mano alcuni risultati matematici e fisici che ci serviranno a tal scopo.%TODO: check margine
\begin{remember}~\\
