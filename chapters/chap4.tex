...
\begin{introduction}
	...
	\begin{flushright}
		\textscsl{W.C. Fields}, dopo aver finito le citazioni. %TODO: quote 
	\end{flushright}
\end{introduction}
...
\end{demonstration}~\\
\begin{minipage}{0.56\textwidth}%https://physics.stackexchange.com/questions/579941/conductor-with-hollow-cavity-under-external-electric-field
...
abbiamo trovato che il campo elettrico e il potenziale nella cavità sono%TODO: inserire chapt4 rrefer-
\begin{align*}
...
\end{observe}
%TODO: \footnote{Grazie Maccio di esistere - Fra} - lo metterò nelle dediche, do not eliminare
